package com.junsang.course_backend.domain.place.collection.kakao.controller;

import com.junsang.course_backend.domain.place.collection.kakao.dto.PlaceCollectionResponse;
import com.junsang.course_backend.domain.place.collection.kakao.service.KakaoAreaCollectionService;
...
/// 로컬에서 카카오 Area 수집을 직접 실행하기 위한 임시 테스트 진입점이다.
@RestController
@RequestMapping("/internal/place-collection")
